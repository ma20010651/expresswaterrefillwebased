...
<td>
    <center>
    <?php if ($row['status'] != 'Delivered' && $row['status'] != 'Cancelled' && $row['status'] != 'Out for Delivery') : ?>
    <a class="btn btn-primary" style="font-size: 13px" href="cancel.php?ref_number=<?php echo $row['ref_number']; ?>"><b>Cancel Order</b></a>
       <?php endif; ?>
    </center>
</tr>
