    ...
    <table id="myTable" class="table table-hover table-striped table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="badge bg-primary rounded-pill" style="color: white">Pending</span></td>
          <td>
            <a class="btn btn-warning" href="editapplicant.php?id=<?php echo $row['id']; ?>"><b>Verify</a></b>
          </td>
        </tr>
        <?php 
          } 
