...
<div class="content">
  <div class="card">
    <div class="card-header d-flex justify-content-between">
      <h3 class="card-title">List of Denied Applicants</h3>
  ...
  <div class="card-body">
    <table id="myTable" class="table table-hover table-striped table-bordered">
      <colgroup>
        <!-- Define your column widths here if necessary -->
      </colgroup>
      <thead>
        <tr>
          <th>No</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="badge bg-danger rounded-pill" style="color: white;">Denied</span></td>
